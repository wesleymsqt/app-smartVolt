...
import { Save, Clock, ChevronDown, ChevronUp, CalendarDays, Trash2 } from 'lucide-react-native';
...
export function EditRoutine() {
  ...
  const { routine, onEdit, onDelete } = route.params || {};
  ...
  const initialTimes = routine?.time ? routine.time.split(' - ') : ['00:00', '00:00'];
  ...
  return (
    <SafeAreaView style={styles.container}>
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        <Header title="Editar Rotina" onBack={() => navigation.goBack()} />
      ...
      <AppModal visible={deleteModalVisible} onClose={() => setDeleteModalVisible(false)} title="Excluir Rotina">
        ...
        <View style={styles.modalButtonsRow}>
          ...
          <View style={{ width: 12 }} />
          <View style={{ flex: 1 }}>
            <Button title="Excluir" variant="secondary" onPress={handleDeleteConfirm} />
          </View>
        </View>
      </AppModal>
